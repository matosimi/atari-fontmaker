namespace FontMaker
{
	partial class FontMakerForm
	{
		...
		private void InitializeComponent()
		{
			...
			var resources = new System.ComponentModel.ComponentResourceManager(typeof(FontMakerForm));
			...
			buttonCopyAreaHMirror = new Button();
			comboBoxPasteIntoFontNr = new ComboBox();
			buttonPasteInPlace = new Button();
			buttonCopyAreaShiftDown = new Button();
			buttonCopyAreaShiftUp = new Button();
			buttonCopyAreaShiftRight = new Button();
			buttonCopyAreaShiftLeft = new Button();
			buttonFontShiftRightInsert = new Button();
			buttonFontShiftRightRotate = new Button();
			buttonFontShiftLeftRotate = new Button();
			...
			pictureBoxRecolorSourceColorMode10 = new PictureBox();
			...
			p_xx.Controls.Add(label4);
			p_xx.Controls.Add(label3);
			...
			Bevel3.Location = new Point(63, 5);
			Bevel3.Name = "Bevel3";
			...
			// 
			pictureBoxCharacterEditorColor1.Location = new Point(8, 6);
			...
			// 
			pictureBoxCharacterEditorColor2.Location = new Point(232, 6);
			...
			// buttonShiftUp
			// 
			buttonShiftUp.Location = new Point(232, 89);
			...
			// 
			buttonMirrorVertical.Location = new Point(232, 47);
			...
			// buttonShiftRight
			// 
			buttonShiftRight.Location = new Point(232, 68);
			...
			// buttonShiftLeft
			// 
			buttonShiftLeft.Location = new Point(8, 68);
			...
			// buttonShiftDown
			// 
			buttonShiftDown.Location = new Point(8, 89);
			...
			// buttonRotateRight
			// 
			buttonRotateRight.Location = new Point(232, 26);
			...
			// buttonRotateLeft
			// 
			buttonRotateLeft.Location = new Point(8, 26);
			...
			// buttonRestoreSaved
			// 
			buttonRestoreSaved.Location = new Point(8, 131);
			...
			// 
			buttonRestoreDefault.Location = new Point(8, 110);
			...
			// buttonInverse
			// 
			buttonInverse.Location = new Point(232, 110);
			...
			// 
			buttonMirrorHorizontal.Location = new Point(8, 47);
			...
			// buttonClear
			// 
			buttonClear.Location = new Point(232, 131);
			...
			// buttonCopy
			// 
			buttonCopy.Location = new Point(8, 152);
			...
			// buttonPaste
			// 
			buttonPaste.Location = new Point(232, 152);
			...
			// 
			pictureBoxActionColor.Location = new Point(115, 172);
			...
			// labelEditCharInfo
			// 
			labelEditCharInfo.Location = new Point(212, 188);
			labelEditCharInfo.Name = "labelEditCharInfo";
			labelEditCharInfo.Size = new Size(69, 29);
			labelEditCharInfo.TabIndex = 1;
			labelEditCharInfo.Text = "Font 1\n$00 #0";
			labelEditCharInfo.TextAlign = ContentAlignment.MiddleRight;
			// 
			// labelColor
			// 
			labelColor.AutoSize = true;
			labelColor.Location = new Point(73, 173);
			...
			cmbColor9Menu.Location = new Point(114, 170);
			...
			buttonRedo.Location = new Point(35, 204);
			...
			cmbColorMode.Location = new Point(2, 33);
			...
			comboBoxColorSets.Location = new Point(5, 154);
			...
			Bevel4.Location = new Point(5, 58);
			...
			buttonSwitchGraphicsMode.Size = new Size(99, 25);
			...
			// buttonExportFont
			// 
			buttonExportFont.Location = new Point(5, 204);
			buttonExportFont.Name = "buttonExportFont";
			buttonExportFont.Size = new Size(92, 25);
			...
			buttonRecolor.Location = new Point(5, 177);
			...
			p_status.Controls.Add(buttonCopyAreaVMirror);
			p_status.Controls.Add(buttonCopyAreaHMirror);
			p_status.Controls.Add(comboBoxPasteIntoFontNr);
			p_status.Controls.Add(buttonPasteInPlace);
			p_status.Controls.Add(buttonCopyAreaShiftDown);
			p_status.Controls.Add(buttonCopyAreaShiftUp);
			p_status.Controls.Add(buttonCopyAreaShiftRight);
			p_status.Controls.Add(buttonCopyAreaShiftLeft);
			p_status.Controls.Add(buttonFontShiftRightInsert);
			p_status.Controls.Add(buttonFontShiftRightRotate);
			...
			// imageListFontShift
			// 
			imageListFontShift.ColorDepth = ColorDepth.Depth8Bit;
			imageListFontShift.ImageStream = (ImageListStreamer)resources.GetObject("imageListFontShift.ImageStream");
			imageListFontShift.TransparentColor = Color.Transparent;
			imageListFontShift.Images.SetKeyName(0, "ShiftLeftInsert.bmp");
			imageListFontShift.Images.SetKeyName(1, "ShiftRightInsert.bmp");
			imageListFontShift.Images.SetKeyName(2, "FontShiftLeftRotate.bmp");
			imageListFontShift.Images.SetKeyName(3, "FontShiftRightRotate.bmp");
			imageListFontShift.Images.SetKeyName(4, "CopyAreaShiftLeft.bmp");
			imageListFontShift.Images.SetKeyName(5, "CopyAreaShiftRight.bmp");
			imageListFontShift.Images.SetKeyName(6, "CopyAreaShiftUp.bmp");
			imageListFontShift.Images.SetKeyName(7, "CopyAreaShiftDown.bmp");
			imageListFontShift.Images.SetKeyName(8, "CopyAreaHMirror.bmp");
			imageListFontShift.Images.SetKeyName(9, "CopyAreaVMirror.bmp");
			...
			buttonCopyAreaRotateLeft.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonCopyAreaRotateLeft, "Rotate Copy Area Left");
			buttonCopyAreaRotateLeft.UseVisualStyleBackColor = true;
			buttonCopyAreaRotateLeft.Click += buttonCopyAreaRotateLeft_Click;
			// 
			// buttonCopyAreaInvert
			// 
			...
			buttonCopyAreaInvert.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonCopyAreaInvert, "Invert Copy Area");
			buttonCopyAreaInvert.UseVisualStyleBackColor = true;
			buttonCopyAreaInvert.Click += buttonCopyAreaInvert_Click;
			// 
			// buttonCopyAreaVMirror
			// 
			...
			buttonCopyAreaVMirror.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonCopyAreaVMirror, "Vertical Mirror Copy Area");
			buttonCopyAreaVMirror.UseVisualStyleBackColor = true;
			buttonCopyAreaVMirror.Click += buttonCopyAreaVMirror_Click;
			// 
			// buttonCopyAreaHMirror
			// 
			...
			buttonCopyAreaHMirror.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonCopyAreaHMirror, "Horizontal Mirror Copy Area");
			buttonCopyAreaHMirror.UseVisualStyleBackColor = true;
			buttonCopyAreaHMirror.Click += buttonCopyAreaHMirror_Click;
			// 
			// comboBoxPasteIntoFontNr
			// 
			comboBoxPasteIntoFontNr.DropDownStyle = ComboBoxStyle.DropDownList;
			...
			toolTips.SetToolTip(comboBoxPasteIntoFontNr, "Which font to paste into?");
			comboBoxPasteIntoFontNr.SelectedIndexChanged += comboBoxPasteIntoFontNr_SelectedIndexChanged;
			// 
			// buttonPasteInPlace
			// 
			...
			buttonCopyAreaShiftDown.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonCopyAreaShiftDown, "Shift Copy Area Down");
			buttonCopyAreaShiftDown.UseVisualStyleBackColor = true;
			buttonCopyAreaShiftDown.Click += buttonCopyAreaShiftDown_Click;
			// 
			// buttonCopyAreaShiftUp
			// 
			...
			buttonCopyAreaShiftUp.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonCopyAreaShiftUp, "Shift Copy Area Up");
			buttonCopyAreaShiftUp.UseVisualStyleBackColor = true;
			buttonCopyAreaShiftUp.Click += buttonCopyAreaShiftUp_Click;
			// 
			// buttonCopyAreaShiftRight
			// 
			...
			buttonCopyAreaShiftRight.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonCopyAreaShiftRight, "Shift Copy Area Right");
			buttonCopyAreaShiftRight.UseVisualStyleBackColor = true;
			buttonCopyAreaShiftRight.Click += buttonCopyAreaShiftRight_Click;
			// 
			// buttonCopyAreaShiftLeft
			// 
			...
			buttonCopyAreaShiftLeft.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonCopyAreaShiftLeft, "Shift Copy Area Left");
			buttonCopyAreaShiftLeft.UseVisualStyleBackColor = true;
			buttonCopyAreaShiftLeft.Click += buttonCopyAreaShiftLeft_Click;
			// 
			// buttonFontShiftRightInsert
			// 
			...
			buttonFontShiftRightInsert.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonFontShiftRightInsert, "Shift Chars Right Insert Hole");
			buttonFontShiftRightInsert.UseVisualStyleBackColor = true;
			buttonFontShiftRightInsert.Click += buttonFontShiftRightInsert_Click;
			// 
			// buttonFontShiftRightRotate
			// 
			...
			buttonFontShiftRightRotate.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonFontShiftRightRotate, "Rotate Chars Right");
			buttonFontShiftRightRotate.UseVisualStyleBackColor = true;
			buttonFontShiftRightRotate.Click += buttonFontShiftRightRotate_Click;
			// 
			// buttonFontShiftLeftRotate
			// 
			...
			buttonFontShiftLeftRotate.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonFontShiftLeftRotate, "Rotate Chars Left");
			buttonFontShiftLeftRotate.UseVisualStyleBackColor = true;
			buttonFontShiftLeftRotate.Click += buttonFontShiftLeftRotate_Click;
			// 
			// buttonFontShiftLeftInsert
			// 
			...
			buttonFontShiftLeftInsert.TextImageRelation = TextImageRelation.ImageBeforeText;
			toolTips.SetToolTip(buttonFontShiftLeftInsert, "Shift Chars Left Insert Hole");
			buttonFontShiftLeftInsert.UseVisualStyleBackColor = true;
			buttonFontShiftLeftInsert.Click += buttonFontShiftLeftInsert_Click;
			// 
			// checkBoxFontBank
			// 
			...
			buttonMegaCopy.Location = new Point(159, 2);
			buttonMegaCopy.Name = "buttonMegaCopy";
			buttonMegaCopy.Size = new Size(216, 21);
			...
			// buttonAddPage
			// 
			buttonAddPage.Location = new Point(131, 33);
			...
			// buttonDeletePage
			// 
			buttonDeletePage.Location = new Point(159, 33);
			...
			label1.Text = "Pages:";
			// 
			// labelCurrentPageInfo
			// 
			labelCurrentPageInfo.AutoSize = true;
			labelCurrentPageInfo.Location = new Point(53, 9);
			labelCurrentPageInfo.Name = "labelCurrentPageInfo";
			labelCurrentPageInfo.Size = new Size(36, 13);
			labelCurrentPageInfo.TabIndex = 29;
			labelCurrentPageInfo.Text = "1 of 1";
			// 
			// panelColorSwitcherMode10
			// 
			panelColorSwitcherMode10.Controls.Add(pictureBoxRecolorSourceColorMode10);
			panelColorSwitcherMode10.Controls.Add(pictureBoxRecolorTargetColorMode10);
			panelColorSwitcherMode10.Controls.Add(listBoxRecolorSourceMode10);
			panelColorSwitcherMode10.Controls.Add(listBoxRecolorTargetMode10);
			panelColorSwitcherMode10.Location = new Point(696, 8);
			panelColorSwitcherMode10.Name = "panelColorSwitcherMode10";
			panelColorSwitcherMode10.Size = new Size(153, 161);
			panelColorSwitcherMode10.TabIndex = 8;
			panelColorSwitcherMode10.Visible = false;
			// 
			// pictureBoxRecolorSourceColorMode10
			// 
			pictureBoxRecolorSourceColorMode10.Location = new Point(8, 135);
			pictureBoxRecolorSourceColorMode10.Name = "pictureBoxRecolorSourceColorMode10";
			pictureBoxRecolorSourceColorMode10.Size = new Size(65, 17);
			pictureBoxRecolorSourceColorMode10.TabIndex = 0;
			pictureBoxRecolorSourceColorMode10.TabStop = false;
			pictureBoxRecolorSourceColorMode10.Tag = 4;
			// 
			// pictureBoxRecolorTargetColorMode10
			// 
			pictureBoxRecolorTargetColorMode10.Location = new Point(80, 135);
			pictureBoxRecolorTargetColorMode10.Name = "pictureBoxRecolorTargetColorMode10";
			pictureBoxRecolorTargetColorMode10.Size = new Size(65, 17);
			pictureBoxRecolorTargetColorMode10.TabIndex = 1;
			pictureBoxRecolorTargetColorMode10.TabStop = false;
			pictureBoxRecolorTargetColorMode10.Tag = 4;
			// 
			// listBoxRecolorSourceMode10
			// 
			listBoxRecolorSourceMode10.FormattingEnabled = true;
			listBoxRecolorSourceMode10.Items.AddRange(new object[] { "Color 0", "Color 1", "Color 2", "Color 3", "Color 4", "Color 5", "Color 6", "Color 7", "Color 8" });
			listBoxRecolorSourceMode10.Location = new Point(8, 8);
			listBoxRecolorSourceMode10.Name = "listBoxRecolorSourceMode10";
			listBoxRecolorSourceMode10.Size = new Size(65, 121);
			listBoxRecolorSourceMode10.TabIndex = 0;
			listBoxRecolorSourceMode10.Click += RecolorSourceMode10_Click;
			// 
			// listBoxRecolorTargetMode10
			// 
			listBoxRecolorTargetMode10.FormattingEnabled = true;
			listBoxRecolorTargetMode10.Items.AddRange(new object[] { "Color 0", "Color 1", "Color 2", "Color 3", "Color 4", "Color 5", "Color 6", "Color 7", "Color 8" });
			listBoxRecolorTargetMode10.Location = new Point(80, 8);
			listBoxRecolorTargetMode10.Name = "listBoxRecolorTargetMode10";
			listBoxRecolorTargetMode10.Size = new Size(65, 121);
		...
		private Button buttonFontShiftRightInsert;
		private ImageList imageListFontShift;
		private Button buttonFontShiftRightRotate;
		private Button buttonFontShiftLeftRotate;
		private Button buttonFontShiftLeftInsert;
		private Button buttonCopyAreaShiftDown;
		private Button buttonCopyAreaShiftUp;
		private Button buttonCopyAreaShiftRight;
		private Button buttonCopyAreaShiftLeft;
		private Button buttonPasteInPlace;
		private ComboBox comboBoxPasteIntoFontNr;
		private Button buttonCopyAreaVMirror;
		private Button buttonCopyAreaHMirror;
		private Button buttonCopyAreaInvert;
		...
		private Panel panelColorSwitcherMode10;
		private PictureBox pictureBoxRecolorSourceColorMode10;
		private PictureBox pictureBoxRecolorTargetColorMode10;
		private ListBox listBoxRecolorSourceMode10;
		private ListBox listBoxRecolorTargetMode10;
